...
function entryPoint(){
    ...
    if (action == 'generate'){
        ...
        console.log(`To generate a Public Key that ends with "${publicSuffix}" will take an est. of ${estimation.attempts} attempts and ${estimation.time} ms! Only run the generator if this sound feasible.`);
    }
}
